...
int main()
{
	clsEmployee Mazin(100, "Mazin", "Al-Shehri", "imaz@ouo.com", "0583059181", "Software Engineer", 30000, "Jedco ICT");

	Mazin.Print();
	cout << '\n';
	cout << Mazin.get_title() << endl;
	cout << Mazin.get_salary() << endl;
	cout << Mazin.get_department() << endl;
}